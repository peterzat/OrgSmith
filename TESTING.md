...
Expect ~85s wall and 952 passing + 27 skipped (16 short, 708 unit, 228 org)
on a box with LibreOffice; 944 passing + 35 skipped without it (the six
...
| `unit` | deterministic logic, schemas, renderers, the airlock contract, ledger math, built on synthetic orgs in `tmp_path` | 708 (702 in CI) | ~75s | ~71s local |
