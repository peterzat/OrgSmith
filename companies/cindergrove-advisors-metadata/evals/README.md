# Golden eval suites for `cindergrove-advisors`

Emitted by `python -m orgsmith emit-evals cindergrove-advisors`. Deterministic: derived
...
paths), `tags`. Run your retrieval system over the `companies/cindergrove-advisors/`
