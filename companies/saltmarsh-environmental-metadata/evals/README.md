# Golden eval suites for `saltmarsh-environmental`

Emitted by `python -m orgsmith emit-evals saltmarsh-environmental`. Deterministic: derived
...
paths), `tags`. Run your retrieval system over the `companies/saltmarsh-environmental/`
