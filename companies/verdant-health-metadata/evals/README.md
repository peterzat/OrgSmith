# Golden eval suites for `verdant-health`

Emitted by `python -m orgsmith emit-evals verdant-health`. Deterministic: derived
...
paths), `tags`. Run your retrieval system over the `companies/verdant-health/`
