# Golden eval suites for `calderwood-partners`

Emitted by `python -m orgsmith emit-evals calderwood-partners`. Deterministic: derived
...
paths), `tags`. Run your retrieval system over the `companies/calderwood-partners/`
