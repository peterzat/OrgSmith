# Golden eval suites for `fernhollow-partners`

Emitted by `python -m orgsmith emit-evals fernhollow-partners`. Deterministic: derived
...
paths), `tags`. Run your retrieval system over the `companies/fernhollow-partners/`
