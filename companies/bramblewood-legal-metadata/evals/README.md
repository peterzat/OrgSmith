# Golden eval suites for `bramblewood-legal`

Emitted by `python -m orgsmith emit-evals bramblewood-legal`. Deterministic: derived
...
paths), `tags`. Run your retrieval system over the `companies/bramblewood-legal/`
