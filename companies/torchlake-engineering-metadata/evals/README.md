# Golden eval suites for `torchlake-engineering`

Emitted by `python -m orgsmith emit-evals torchlake-engineering`. Deterministic: derived
...
paths), `tags`. Run your retrieval system over the `companies/torchlake-engineering/`
