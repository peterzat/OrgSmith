# Golden eval suites for `quillbrook-appraisal`

Emitted by `python -m orgsmith emit-evals quillbrook-appraisal`. Deterministic: derived
...
paths), `tags`. Run your retrieval system over the `companies/quillbrook-appraisal/`
